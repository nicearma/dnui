<div id="imagesDNUI" ng-controller="ImagesCtrl">
    ...
    <div ng-if="(callServerStatus==2)&&(images.length>0)">
        <span class="text-success" ng-click="changeShowUsedImage()" ng-if="options.showUsedImage"><?php _e('Images used are displayed, click here for hide them', 'dnui') ?></span>
        <span class="text-warning" ng-click="changeShowUsedImage()" ng-if="!options.showUsedImage"><?php _e('Images used are hidden, click here for show them', 'dnui') ?></span>
        <br/>
